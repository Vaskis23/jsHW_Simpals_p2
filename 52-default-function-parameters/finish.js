...
/**
 * В решении задачи с использованием параметра функции по умолчанию мы определяем функцию "weatherForecast" с двумя параметрами. 
 * Параметр "weather" имеет значение по умолчанию, указанное после знака "=".
 * Затем вызваем функцию "weatherForecast" с разными комбинациями аргументов:
 * Когда мы вызываем функцию "weatherForecast", мы передаем значение для параметра "city" и, при необходимости, значение для параметра "weather". 
